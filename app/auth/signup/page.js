...
export default function SignupPage() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      // Profile will be created automatically by trigger in database
    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-secondary)] px-4 py-12">
      <div className="max-w-md w-full glass p-10 rounded-3xl shadow-2xl gradient-border-brown">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-display font-bold text-[var(--text-main)] mb-3 tracking-tight">Create Account</h1>
          <p className="text-[var(--text-muted)]">Join Ahmed Kapadia's exclusive network</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          <div>
            <label className="block text-sm font-bold text-[var(--text-main)] mb-3 uppercase tracking-wider">Full Name</label>
            <div className="relative">
              <User className="absolute left-4 top-4 w-5 h-5 text-[var(--text-muted)]" />
              <input
                type="text"
                name="name"
                required
          ...
          <div>
            <label className="block text-sm font-bold text-[var(--text-main)] mb-3 uppercase tracking-wider">Confirm Password</label>
            <div className="relative">
              <Lock className="absolute left-4 top-4 w-5 h-5 text-[var(--text-muted)]" />
              <input
                type="password"
        ...
        <p className="mt-8 text-center text-[var(--text-muted)]">
          ...
          <Link href="/auth/signin" className="text-primary-600 dark:text-primary-400 font-semibold hover:underline">
            Sign In
          </Link>
        </p>
      </div>
